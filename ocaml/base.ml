...
(* An ext_axiom with a prefix and a suffix *)
...
let string_of_ext_grammar (g : ext_grammar) : string = "ext_axiom: " ^ (string_of_ext_element g.ext_axiom) ^ "\nRules: " ^ (string_of_ext_rules g.ext_rules)
