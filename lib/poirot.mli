 ...
 *)
val search : ?oneline_comment: string option -> ?subst:(element,string) Hashtbl.t option -> ?max_depth:int -> ?max_steps:int -> ?forbidden_chars:char list -> ?sgraph_fname:string option -> ?qgraph_fname:string option -> ?save_h:bool -> (string option -> oracle_status) -> grammar -> element -> element list -> (grammar * string) option
